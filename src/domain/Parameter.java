...
@Entity
//@Audited
@Table (name = "parameter", schema = "raw_data_test")
@SequenceGenerator (name = "parameter_gen", sequenceName = "parameter_id_seq", allocationSize = 1)
...
//    private static final long serialVersionUID = ObjectStreamClass.lookup(Location.class).getSerialVersionUID();   
    ...
    public Parameter( String code, String name, String description, String unit) {
